(async () => {
  ...
  document.getElementById("pauseRecord").addEventListener("click",()=>{
    //录音暂停按钮点击 显示恢复按钮
    if ($('#pauseRecord').hasClass('disBtn') == false) {
      $('#pauseRecord').addClass('disBtn');
  ...
  document.getElementById("resumeRecord").addEventListener("click",()=>{
    //录音恢复按钮点击 显示暂停按钮
    if ($('#resumeRecord').hasClass('disBtn') == false) {
      $('#resumeRecord').addClass('disBtn');
  ...
  document.getElementById("exitRecord").addEventListener("click",()=>{//退出按钮
